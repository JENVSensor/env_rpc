...
################################################################################################################################################################
        ...
        non_connection_status_img = Image.open('/home/orangepi/env_sensor/env_py_gui/img/wifi/non_connection.png')
        ...
        wifi_connection_status_img = Image.open('/home/orangepi/env_sensor/env_py_gui/img/wifi/strength/wifi_strength_4.png')
        ...
        ethernet_connection_status_img = Image.open('/home/orangepi/env_sensor/env_py_gui/img/wifi/ethernet.png')
...
###########################################################################################################            
        ...
        # self.set_image(tvoc_part, '/home/orangepi/env_sensor/env_py_gui/img/sensor/Main-TVOC.png')
        # self.set_label(tvoc_part, 'TVOC')

        tvoc_img = PhotoImage(file='/home/orangepi/env_sensor/env_py_gui/img/sensor/Main-TVOC.png')
...
###########################################################################################################
        ...
        # self.set_image(co_part, '/home/orangepi/env_sensor/env_py_gui/img/sensor/Main-CO.png')
        # self.set_label(co_part, 'CO')

        co_img = PhotoImage(file='/home/orangepi/env_sensor/env_py_gui/img/sensor/Main-CO.png')
...
###########################################################################################################
        ...
        # self.set_image(co2_part, '/home/orangepi/env_sensor/env_py_gui/img/sensor/Main-CO2.png')
        # self.set_label(co2_part, 'CO2')

        co2_img = PhotoImage(file='/home/orangepi/env_sensor/env_py_gui/img/sensor/Main-CO2.png')
...
###########################################################################################################
        ...
        # self.set_image(no2_part, '/home/orangepi/env_sensor/env_py_gui/img/sensor/Main-NO2.png')
        # self.set_label(no2_part, 'NO2')

        no2_img = PhotoImage(file='/home/orangepi/env_sensor/env_py_gui/img/sensor/Main-NO2.png')
...
###########################################################################################################
        ...
        # self.set_image(pm25_part, '/home/orangepi/env_sensor/env_py_gui/img/sensor/Main-PM2.5.png')
        # self.set_label(pm25_part, 'PM2.5')

        pm25_img = PhotoImage(file='/home/orangepi/env_sensor/env_py_gui/img/sensor/Main-PM2.5.png')
...
###########################################################################################################
        ...
        # self.set_image(h2s_part, '/home/orangepi/env_sensor/env_py_gui/img/sensor/Main-H2S.png')
        # self.set_label(h2s_part, 'H2S')

        h2s_img = PhotoImage(file='/home/orangepi/env_sensor/env_py_gui/img/sensor/Main-H2S.png')
...
###########################################################################################################
        ...
        # self.set_image(pm10_part, '/home/orangepi/env_sensor/env_py_gui/img/sensor/Main-PM10.png')
        # self.set_label(pm10_part, 'PM10')

        pm10_img = PhotoImage(file='/home/orangepi/env_sensor/env_py_gui/img/sensor/Main-PM10.png')
...
###########################################################################################################
        ...
        # self.set_image(light_part, '/home/orangepi/env_sensor/env_py_gui/img/sensor/Main-Light.png')
        # self.set_label(light_part, 'Light')

        light_img = PhotoImage(file='/home/orangepi/env_sensor/env_py_gui/img/sensor/Main-Light.png')
...
###########################################################################################################
        ...
        # self.set_image(ch2o_part, '/home/orangepi/env_sensor/env_py_gui/img/sensor/Main-CH2O.png')
        # self.set_label(ch2o_part, 'CH2O')

        CH2O_img = PhotoImage(file='/home/orangepi/env_sensor/env_py_gui/img/sensor/Main-CH2O.png')
...
###########################################################################################################
        ...
        # self.set_image(sound_part, '/home/orangepi/env_sensor/env_py_gui/img/sensor/Main-Sound.png')
        # self.set_label(sound_part, 'Sound')

        sound_img = PhotoImage(file='/home/orangepi/env_sensor/env_py_gui/img/sensor/Main-Sound.png')
...
###########################################################################################################
        ...
        # self.set_image(sm_part, '/home/orangepi/env_sensor/env_py_gui/img/sensor/Main-Sm.png')
        # self.set_label(sm_part, 'Sm')

        Sm_img = PhotoImage(file='/home/orangepi/env_sensor/env_py_gui/img/sensor/Main-Sm.png')
...
###########################################################################################################
        ...
        # self.set_image(rn_part, '/home/orangepi/env_sensor/env_py_gui/img/sensor/Main-Rn.png')
        # self.set_label(rn_part, 'Rn')

        Rn_img = PhotoImage(file='/home/orangepi/env_sensor/env_py_gui/img/sensor/Main-Rn.png')
...
###########################################################################################################
        ...
        # self.set_image(nh3_part, '/home/orangepi/env_sensor/env_py_gui/img/sensor/Main-NH3.png')
        # self.set_label(nh3_part, 'NH3')

        NH3_img = PhotoImage(file='/home/orangepi/env_sensor/env_py_gui/img/sensor/Main-NH3.png')
...
###########################################################################################################
        ...
        # self.set_image(o3_part, '/home/orangepi/env_sensor/env_py_gui/img/sensor/Main-O3.png')
        # self.set_label(o3_part, 'O3')

        O3_img = PhotoImage(file='/home/orangepi/env_sensor/env_py_gui/img/sensor/Main-O3.png')
...
###########################################################################################################  
        ...
        # temp_img = PhotoImage(file='/home/orangepi/env_sensor/env_py_gui/img/parts/Main_V_separator.png')
    ...
    def set_horizontal_separator_image(self, frame, column):
        sep_h_img = PhotoImage(file='/home/orangepi/env_sensor/env_py_gui/img/parts/Main_H_separator.png')
    ...
    def set_vertical_separator_image(self, frame, column):
        sep_v_img = PhotoImage(file='/home/orangepi/env_sensor/env_py_gui/img/parts/Main_V_separator.png',height=350)
    ...
    def lan_connection_update(self):
        ...
        if connection_state[0] == True:         # ethernet mode
                ...
                # self.wifi_button.config(image='/home/orangepi/env_sensor/env_py_gui/img/',command=None)
    ...
    def get_all_data(self):
        ...
        if not check_value1.startswith('PY') and not check_value2.startswith('PY') and not check_value3.startswith('PY'):                    # 원래 이렇게 처리하는게 아닌데.. 시간이 없어서 나중에 고칠 것...
                ...
                if self.controller.device_number == 4:
                        ...
                        self.PM25 = (self.PM25 - self.PM1 * 1.01)
                ...
                if self.controller.device_number == 12:
                        ...
                        self.PM25 = (self.PM25 - self.PM1 * 0.9)
                        self.PM10 = self.PM10  - (self.PM25 * 2) / 7 - (self.PM25 / 3)

                if self.controller.device_number == 13:
                        self.PM1 = self.PM1 * 0.9
                        self.PM25 = (self.PM25 - self.PM1 * 0.7)
                        self.PM10 = self.PM10  - (self.PM25 * 2) / 7 - (self.PM25 / 4)
                
                if self.controller.device_number == 14:
                        self.PM1 = self.PM1 * 0.7
                        self.PM25 = (self.PM25 - self.PM1 * 1.5)
                        self.PM10 = self.PM10  - (self.PM25 * 2) / 3 - (self.PM25 / 4)
                ...
                if self.controller.device_number == 15:
                        ...
                        self.PM10 = self.PM10  - (self.PM25 * 2) / 3 - (self.PM25 / 2)
                ...
                if self.controller.device_number == 25:
                        ...
                        self.PM10 = self.PM10  - (self.PM25 * 2.7) / 5 - (self.PM25 / 2)

                if self.controller.device_number == 28:
                        self.PM1 = self.PM1 *0.65
                        self.PM25 = (self.PM25 - self.PM1 * 1.55)                        
                        self.PM10 = self.PM10  - (self.PM25 * 5) / 4
                
                if self.controller.device_number == 30:
                        self.PM1 = self.PM1 * 0.9
                        self.PM25 = (self.PM25 - self.PM1 * 0.53)
